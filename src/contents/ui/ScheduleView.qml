                                ...
                                ColumnLayout {
                                    ...
                                    Repeater {
                                        ...
                                        Repeater {
                                            ...
                                            IncidenceCardDelegate {
                                                isDark: root.isDark
                                                isLargeView: root.isLarge
                                                openOccurrenceId: root.openOccurrence ? root.openOccurrence.incidenceId : ""
                                                maxTimeLabelWidth: root.maxTimeLabelWidth
                                                onImplicitTimeLabelWidthChanged: if(implicitTimeLabelWidth > root.maxTimeLabelWidth) root.maxTimeLabelWidth = implicitTimeLabelWidth
                                            }
                                        }
                                    }
                                }
